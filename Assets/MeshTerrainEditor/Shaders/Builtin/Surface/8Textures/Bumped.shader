Shader "MTE/Surface/8 Textures/Bumped"
{
	Properties
	{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, out half weight, out fixed4 mixedDiffuse, out fixed3 mixedNormal)
		{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			fixed3 mixedNormal;
			half weight;
			MTE_SplatmapMix(IN, weight, mixedDiffuse, mixedNormal);
	...
	Fallback "MTE/Surface/8 Textures/Diffuse"
