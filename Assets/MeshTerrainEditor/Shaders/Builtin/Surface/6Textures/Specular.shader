Shader "MTE/Surface/6 Textures/Specular"
{
	Properties
	{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, out half weight, out fixed4 mixedDiffuse, inout fixed3 mixedNormal)
		{
			...
			nrm += splat_control_extra.g * tex2D(_Normal5, uvSplat5);
	...
	Fallback "MTE/Surface/6 Textures/Bumped"
