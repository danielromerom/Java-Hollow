// Upgrade NOTE: upgraded instancing buffer 'MTEStandardExperimentalPacked4Textures' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "MTE/Standard/Experimental/Packed/4Textures"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma only_renderers d3d11_9x d3d11 gles3 metal vulkan 
		...
		UNITY_INSTANCING_BUFFER_START(MTEStandardExperimentalPacked4Textures)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Control_ST)
#define _Control_ST_arr MTEStandardExperimentalPacked4Textures
			UNITY_DEFINE_INSTANCED_PROP(float4, _HeightWeight)
#define _HeightWeight_arr MTEStandardExperimentalPacked4Textures
			UNITY_DEFINE_INSTANCED_PROP(float4, _Metallic)
#define _Metallic_arr MTEStandardExperimentalPacked4Textures
			UNITY_DEFINE_INSTANCED_PROP(float4, _Smoothness)
#define _Smoothness_arr MTEStandardExperimentalPacked4Textures
		UNITY_INSTANCING_BUFFER_END(MTEStandardExperimentalPacked4Textures)
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_74_0 = ( tex2DNode6 * tex2D( _PackedHeightMap, uv_PackedHeightMap ) );
			...
			float2 temp_output_94_0_g102 = uv_PackedHeightMap;
			...
			float4 tex2DNode5 = tex2D( _PackedSplat0, uv_PackedHeightMap );
			float3 appendResult125 = (float3(tex2DNode5.r , tex2DNode5.g , tex2DNode5.b));
			float4 tex2DNode67 = tex2D( _PackedSplat1, uv_PackedHeightMap );
			float3 appendResult126 = (float3(tex2DNode67.r , tex2DNode67.g , tex2DNode67.b));
			float4 tex2DNode68 = tex2D( _PackedSplat2, uv_PackedHeightMap );
...
/*ASEBEGIN
Version=18927
511;107;1920;989;4751.598;1653.746;3.895451;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;83;-2600.47,-233.8694;Inherit;True;Property;_PackedHeightMap;PackedHeightMap;3;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;129;1258.334,-173.4329;Float;False;True;-1;2;MTE.MTEPackedShaderGUI;0;0;Standard;MTE/Standard/Experimental/Packed/4Textures;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;5;d3d11_9x;d3d11;gles3;metal;vulkan;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;129;1;92;0
WireConnection;129;3;141;0
WireConnection;129;4;140;0
ASEEND*/
//CHKSM=F5338C6FF78CB6DE7D36F14091F2A355D2D241ED